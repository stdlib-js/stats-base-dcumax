...
```javascript
import dcumax from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dcumax@v0.2.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dcumax/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-dcumax/actions/workflows/test.yml?query=branch:v0.2.0
